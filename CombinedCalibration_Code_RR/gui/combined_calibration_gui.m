...
% Last Modified by GUIDE v2.5 11-Jun-2015 03:45:05
...
% --- Executes on button press in configBtn.
function configBtn_Callback(hObject, eventdata, handles)
% hObject    handle to configBtn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    configuration_gui;
